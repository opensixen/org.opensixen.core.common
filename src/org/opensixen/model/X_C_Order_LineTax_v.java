...
/** Generated Model for C_Order_LineTax_v
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_C_Order_LineTax_v extends PO implements I_C_Order_LineTax_v, I_Persistent 
{
    ...
    public X_C_Order_LineTax_v (Properties ctx, int C_Order_LineTax_v_ID, String trxName)
    {
      super (ctx, C_Order_LineTax_v_ID, trxName);
      /** if (C_Order_LineTax_v_ID == 0)
        {
        } */
    }

    /** Load Constructor */
    public X_C_Order_LineTax_v (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_C_Order_LineTax_v[")
	...
	{
		set_ValueNoCheck (COLUMNNAME_Discount, Integer.valueOf(Discount));
	}
	...
	/** Set List Prive.
		@param PriceEnteredList 
		Entered List Price
	  */
	public void setPriceEnteredList (BigDecimal PriceEnteredList)
	{
		set_ValueNoCheck (COLUMNNAME_PriceEnteredList, PriceEnteredList);
	}
	...
	{
		BigDecimal bd = (BigDecimal)get_Value(COLUMNNAME_PriceEnteredList);
		if (bd == null)
			 return Env.ZERO;
		return bd;
	}
	...
	{
		set_ValueNoCheck (COLUMNNAME_ResourceDescription, ResourceDescription);
	}

	/** Get Resource Description.
		@return Resource Allocation Description
	  */
	public String getResourceDescription () 
	{
		return (String)get_Value(COLUMNNAME_ResourceDescription);
	}
	...
	{
		set_ValueNoCheck (COLUMNNAME_TaxIndicator, TaxIndicator);
	}
