...
/**
 * InvoiceGenerateValidator 
 *
 * @author Eloy Gomez
 * Indeos Consultoria http://www.indeos.es
 */
public class IncotermInvoiceGenerateValidator extends AbstractDocGenerateModelValidator {
	...
	public String getQueryOrderString() {
		return ", c_order.incoterm, c_order.incoterm_extra ";
	}	
