...
/** Generated Model for RV_OpenItem
 *  @author Adempiere (generated) 
 *  @version Release 3.6.0LTS - $Id$ */
public class X_RV_OpenItem extends PO implements I_RV_OpenItem, I_Persistent 
{
    ...
    public X_RV_OpenItem (Properties ctx, int RV_OpenItem_ID, String trxName)
    {
    ...
    /** Load Constructor */
    public X_RV_OpenItem (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_RV_OpenItem[")
	...
	{
		set_ValueNoCheck (COLUMNNAME_DiscountDate, DiscountDate);
	}
	...
	public void setInvoiceCollectionType (String InvoiceCollectionType)
	{
		...
		set_ValueNoCheck (COLUMNNAME_InvoiceCollectionType, InvoiceCollectionType);
	}
